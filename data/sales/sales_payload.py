...
def build_sales_payload(store_code: str, ownership: str, business_date: str) -> dict:
    ...
    item_stat_list = [{
        "balanceFlag": 1, "beCode": be[k], "businessDate": business_date,
        "createBy": "system", "createTime": _CT, "itemCode": code,
        "itemDescription": desc, "itemQty": qty, "netSales": net,
        "salesAmount": amt, "settlementType": 0, "statCode": sc,
        "statType": "FctNonProduct", "storeCode": store_code, "subStatType": "",
        "taxAmount": tax, "taxRate": rate, "versionNo": 1,
    } for k, code, desc, qty, net, amt, sc, tax, rate in item_rows]

    # ---- paymentList：(amount, tenderId, tenderName) ----
    payment_rows = [
        (255.00, "12", "手机支付"), (4120.30, "29", "MDS美团外卖"),
        (12.30, "180", "微信小程序-麦钱包支付"), (407.30, "182", "支付宝小程序-支付宝支付"),
        (613.60, "154", "App微信支付"), (826.87, "155", "App支付宝支付"),
        (601.50, "210", "自助点餐微信支付"), (191.00, "156", "App麦钱包支付"),
        (268.65, "211", "自助点餐支付宝支付"), (2412.30, "179", "微信小程序-微信支付"),
        (33.50, "223", "抖音支付"), (983.59, "202", "优惠券A"),
        (60.90, "204", "APP云闪付支付"), (23.90, "228", "京东外卖"),
        (360.70, "218", "优惠券B"), (2700.80, "30", "MDS饿了么外卖"),
    ]
    payment_list = [{
        "amount": amt, "balanceFlag": 1, "businessDate": business_date,
        "chequePayment": "", "createBy": "system", "createTime": _PT,
        "currency": "CNY", "dataType": "3", "settlementType": 0,
        "storeCode": store_code, "tenderId": tid, "tenderName": name,
        "tenderType": 1, "versionNo": 1,
    ...
    # beName 为脱敏占位
    sales_rows = [
        ("02", "示例餐厅-MDS", "MDS", 173, "0", 7353.66, "Product Sales", "1", "6", 7795.08, 441.42),
        ("02", "示例餐厅-MDS", "MDS", 173, "1", 44.26, "Non Product Sales", "1", "6", 46.92, 2.66),
        ("02", "示例餐厅-MDS", "MDS", 173, "1", 642.29, "MDS", "2", "6", 680.80, 38.51),
        ("01", "Front Counter", "FC", 160, "0", 4130.17, "Product Sales", "1", "6", 4378.04, 247.87),
        ("01", "Front Counter", "FC", 160, "1", 113.63, "Non Product Sales", "1", "6", 120.45, 6.82),
        ("01", "Front Counter", "FC", 160, "1", 0.00, "MDS", "2", "6", 0.00, 0.00),
        ("01", "Front Counter", "FC", 160, "0", 0.00, "Product Sales", "1", "13", 0.00, 0.00),
        ("01", "Front Counter", "FC", 160, "1", 95.58, "Non Product Sales", "1", "13", 108.00, 12.42),
    ...
    sales_list = [{
        "balanceFlag": 1, "beCode": be[k], "beName": name, "beType": btype,
        "businessDate": business_date, "createBy": "system", "createTime": _PT,
        "currency": "CNY", "gc": gc, "mainItem": main, "netSales": net,
        "ownership": ownership, "salesType": stype, "settlementType": 0,
        "storeCode": store_code, "subItem": sub, "taxId": "", "taxRate": rate,
        "totalSales": total, "totalTax": ttax, "versionNo": 1,
    ...
    stat_list = [{
        "balanceFlag": 1, "beCode": be[k], "businessDate": business_date,
        "createBy": "system", "createTime": _CT, "gc": gc, "netSales": net,
        "ownership": ownership, "salesAmount": amt, "settlementType": 0,
        "statCode": sc, "statType": st, "storeCode": store_code,
        "subStatType": "", "taxAmount": tax, "taxRate": rate, "versionNo": 1,
